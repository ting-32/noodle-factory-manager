          ...
          <div className="flex justify-between items-end mb-5"> 
            <div className="flex items-center gap-2">
              ...
              {order.isAutoGenerated && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-indigo-50 text-indigo-600 text-[10px] font-bold border border-indigo-100">
                  <Bot className="w-3 h-3" /> 系統建單
                </span>
              )}
            </div>
